# coding=utf-8
#
# Renan Monteiro Pinto Neto 25/10/16
...
class CreamyBaconBuilder:
    def __init__(self):
        ...
        self.progress = PizzaProgress.queuedc
        self.baking_time = 7
    ...
    def add_topping(self):
        print('adding the topping (mozzarella, bacon, ham, mushrooms, red onion, oregano) '
              'to your creamy bacon')
